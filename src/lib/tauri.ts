...
export async function getSystemAppearanceSettings(): Promise<SystemAppearanceSettings> {
  return invoke("get_system_appearance_settings")
}

export async function updateSystemAppearanceSettings(
  settings: SystemAppearanceSettings
): Promise<SystemAppearanceSettings> {
  return invoke("update_system_appearance_settings", { settings })
}
