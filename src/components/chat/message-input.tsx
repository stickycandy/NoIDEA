...
export function MessageInput({
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "flex flex-col rounded-[1.1rem] border border-border/40 bg-card/45 shadow-[inset_0_1px_0_rgb(255_255_255_/_0.04)] backdrop-blur-xl transition-colors focus-within:border-ring/55 focus-within:ring-[3px] focus-within:ring-ring/35",
            ...
            {hasImageAttachments && (
              <div className="flex items-center gap-1 overflow-x-auto pb-0.5">
                {imageAttachments.map((attachment) => (
                  <div
                    key={attachment.id}
                    className="relative shrink-0 overflow-hidden rounded-md border border-border/45 bg-card/35"
                  >
                    <Image
                    ...
                    <button
                      ...
                      className="absolute right-1 top-1 rounded-sm bg-card/70 p-0.5 hover:bg-card"
            ...
            {hasResourceAttachments && (
              <div className="flex items-center gap-1 overflow-x-auto">
                {resourceAttachments.map((attachment) => (
                  <div
                    key={attachment.id}
                    className="inline-flex h-6 shrink-0 items-center gap-1 rounded-full border border-border/45 bg-card/40 px-2 text-[11px] text-muted-foreground"
                  >
