          ...
          <ContextMenuTrigger asChild>
            ...
            >
              {STATUS_ORDER.map((status) => {
                ...
                const groupHeader = (
                  <CollapsibleTrigger className="sticky top-0 z-10 flex w-full items-center gap-1.5 bg-sidebar/78 px-1.5 py-1.5 text-xs font-medium text-muted-foreground backdrop-blur-md transition-colors cursor-pointer hover:text-foreground">
                    <ChevronRight
                      className={cn(
